...
// l'esportazione da una DLL. Tutti i file all'interno della DLL sono compilati con il simbolo ACCSMEMREADER_EXPORTS
...
// le funzioni di ACCSMEMREADER_API come se fossero importate da una DLL, mentre questa DLL considera i simboli
// definiti con questa macro come esportati.
#ifdef ACCSMEMREADER_EXPORTS
#define ACCSMEMREADER_API __declspec(dllexport)
#else
#define ACCSMEMREADER_API __declspec(dllimport)
#endif

/*_______________STRUCTS__________________*/
...
extern ACCSMEMREADER_API int InitSM();

//Method to dismiss shared memory segments
extern ACCSMEMREADER_API void DismissSM();
//Methods to read data from shared memory segments
extern ACCSMEMREADER_API void ReadPhysics(SPageFilePhysics* page);
extern ACCSMEMREADER_API void ReadGraphics(SPageFileGraphic* page);
extern ACCSMEMREADER_API void ReadStatic(SPageFileStatic* page);
